...
import 'package:slpod/theme/theme_type.dart';
...
class AppTheme {
  ...
  static ThemeData sailomLightTheme = createTheme(
    ColorScheme.fromSeed(
      seedColor: Color.fromARGB(255, 89, 2, 195),
      primary: Color.fromARGB(255, 89, 2, 195),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xfffdeeea),
      onPrimaryContainer: Color(0xffe73a1f),
      secondary: Color(0xff5e3f22),
  ...
  static ThemeData getShoppingManagerTheme() {
    return createThemeM3(themeType, Color(0xcfe2f3));
  }
  ...
  static resetFont() {
    FxTextStyle.changeFontFamily(GoogleFonts.kanit);
